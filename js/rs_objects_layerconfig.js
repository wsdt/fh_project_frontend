...
var all_objects = []; //Make objects, ONLY YEAR-Subarrays
...
*/
//-----------------------------------------------------------
//1. Configure your objects and save it to your Array (not an assoziative array)
...
all_objects.push(new ol.layer.Tile({
...
all_objects.push(new ol.layer.Vector({
    source: new ol.source.Vector({
        url: "layers/1560/additional_data/124955_subpointtest.kml",
...
//all_objects.push(y1560, y1880, y2016); //IMPORTANT: Rank arrays chronologically (small -> big, 1880->1990->2000->2010)
...
//countKmlObjects (= saved int in html document) ; count_configuredObj (= how many layers are configured)
    if (countKmlObjects !== count_configuredObj) {
